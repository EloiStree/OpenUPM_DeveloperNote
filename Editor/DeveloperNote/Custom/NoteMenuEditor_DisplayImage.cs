...
namespace Eloi.Note
{
    public class NoteMenuEditor_DisplayImage : EditorWindow
    {
        ...
        {
            NoteMenuEditor_DisplayImage window = (NoteMenuEditor_DisplayImage)EditorWindow.GetWindow(typeof(NoteMenuEditor_DisplayImage));
